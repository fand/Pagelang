...
Brainfuck.prototype.leftIdx = function(){
  if (this.pointer === 0) {
...
Brainfuck.prototype.rightIdx = function(){
...
Brainfuck.prototype.incrementIdx = function(){
  this.tape[this.pointer]++;
};

Brainfuck.prototype.decrementIdx = function(){
